...
import com.example.data.repositories.local.LocalTaskWeeklyProgressRepository
import com.example.data.repositories.local.LocalWeeksRepository
...
abstract class RepositoriesModule {
    ...
    @Binds
    @Singleton
    internal abstract fun bindsWeeksRepository(implementation: LocalWeeksRepository): WeeksRepository

    @Binds
    @Singleton
    internal abstract fun bindsTaskWeeklyProgressRepository(implementation: LocalTaskWeeklyProgressRepository): TaskWeeklyProgressRepository
